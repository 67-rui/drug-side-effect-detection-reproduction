...
| `PU_XMSAT_MANUSCRIPT_PACKAGE_AUDIT.md` | Overleaf 论文包审计 | 记录当前 `Template/PU-XMSAT-Overleaf` 源码、上传 zip、模板合规验证、仍需导师确认的占位项和打包规则 |
