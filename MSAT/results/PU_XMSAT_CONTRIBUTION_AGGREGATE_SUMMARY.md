...
- Cases summarized: 2
- Positive node perturbation rows: 7
...
| 3 | `target:8101` | `target` | 1 | 1 | 0.000071 | 0.000071 | 1 | 0 |
| 4 | `target:12337` | `target` | 1 | 1 | 0.000028 | 0.000028 | 1 | 0 |
| 5 | `target:8967` | `target` | 1 | 1 | 0.000028 | 0.000028 | 1 | 0 |
| 6 | `compound:1073` | `compound` | 1 | 1 | 0.000021 | 0.000021 | 1 | 0 |
| 7 | `target:7802` | `target` | 1 | 1 | 0.000002 | 0.000002 | 1 | 0 |
| 8 | `target:2586` | `target` | 1 | 1 | 0.000000 | 0.000000 | 0 | 0 |
