...
| 检查 Overleaf 论文包 | `results/PU_XMSAT_MANUSCRIPT_PACKAGE_AUDIT.md`、`../Template/PU-XMSAT-Overleaf/README.md` | 当前 ACM 模板稿件位置、上传 zip、模板验证状态、占位项和打包规则 |
...
11. Overleaf 论文工程已经整理到 `Template/PU-XMSAT-Overleaf`，上传包为 `Template/PU-XMSAT-Overleaf.zip`；当前 PDF 编译为 12 页 Letter 纸，仍需导师确认作者、机构、目标 venue、CCS、基金和 AI 声明。
