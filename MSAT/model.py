...
class LateFusionPredictor(nn.Module):
    ...
    def __init__(self, emb_dim=72, dropout=0.18, use_late_fusion=True):
        super().__init__()
...
class MultiTypeGraphAttention(nn.Module):
    ...
    def __init__(self, in_channels: int, out_channels: int, num_heads: int = 8,
                 ...
                 use_gated_edge_encoder: bool = True,
                 use_bottleneck_transform: bool = True):
        super().__init__()
        self.use_gated_edge_encoder = use_gated_edge_encoder
        self.use_bottleneck_transform = use_bottleneck_transform
    ...
    def forward(self, x_src, x_dst, edge_index, edge_attr=None):
        ...
        if edge_attr is not None and self.use_gated_edge_encoder:
        ...
        if self.use_bottleneck_transform:
    ...
    def __init__(self, node_types, edge_types, in_channels, out_channels,
        ...
        for edge_type in edge_types:
            ...
            self.convs[conv_key] = MultiTypeGraphAttention(
                ...
                dropout,
                edge_attr_dim,
                use_gated_edge_encoder=use_gated_edge_encoder,
                use_bottleneck_transform=use_bottleneck_transform,
            )
...
class MSATTCMFSFinal(nn.Module):
    ...
    def __init__(self, node_types, edge_types, in_channels_dict,
        ...
        self.prediction_head = LateFusionPredictor(
            out_channels, dropout, use_late_fusion=use_late_fusion
        )
